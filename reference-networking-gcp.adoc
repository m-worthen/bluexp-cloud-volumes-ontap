...
NOTE: A LIF is an IP address associated with a physical or logical port. A storage VM (SVM) management LIF is required for management tools like SnapCenter.
